...
#define LSP_PLUGINS_MB_COMPRESSOR_VERSION_MICRO       38
...
namespace lsp
{
    namespace meta
    {
        ...
        static const port_item_t mb_comp_cross_slopes[] =
        {
        ...
        #define MB_COMMON(bands) \
                ...
                ADDON_COMBO(REV_1, "slope", "Crossover slope", "Slope", meta::mb_compressor_metadata::SLOPE_DEFAULT, mb_comp_cross_slopes ), \
     ...
     */
        ...
        static const port_t mb_compressor_mono_ports[] =
        {
            ...
            MB_SPLIT("_1", " 2", " 2", 0.0f, 40.0f),
            MB_SPLIT("_2", " 3", " 3", 1.0f, 100.0f),
            MB_SPLIT("_3", " 4", " 4", 0.0f, 252.0f),
            MB_SPLIT("_4", " 5", " 5", 1.0f, 632.0f),
            MB_SPLIT("_5", " 6", " 6", 0.0f, 1587.0f),
            MB_SPLIT("_6", " 7", " 7", 1.0f, 3984.0f),
            MB_SPLIT("_7", " 8", " 8", 0.0f, 10000.0f),

            MB_MONO_BAND("_0", " 1", " 1", 0, 8, 10.0f, 40.0f),
            MB_MONO_BAND("_1", " 2", " 2", 1, 8, 40.0f, 100.0f),
            MB_MONO_BAND("_2", " 3", " 3", 2, 8, 100.0f, 252.0f),
            MB_MONO_BAND("_3", " 4", " 4", 3, 8, 252.0f, 632.0f),
            MB_MONO_BAND("_4", " 5", " 5", 4, 8, 632.0f, 1587.0f),
            MB_MONO_BAND("_5", " 6", " 6", 5, 8, 1587.0f, 3984.0f),
            MB_MONO_BAND("_6", " 7", " 7", 6, 8, 3984.0f, 10000.0f),
            MB_MONO_BAND("_7", " 8", " 8", 7, 8, 10000.0f, 20000.0f),
        ...
        static const port_t mb_compressor_stereo_ports[] =
        {
            ...
            MB_STEREO_BAND("_0", " 1", " 1", 0, 8, 10.0f, 40.0f),
            MB_STEREO_BAND("_1", " 2", " 2", 1, 8, 40.0f, 100.0f),
            MB_STEREO_BAND("_2", " 3", " 3", 2, 8, 100.0f, 252.0f),
            MB_STEREO_BAND("_3", " 4", " 4", 3, 8, 252.0f, 632.0f),
            MB_STEREO_BAND("_4", " 5", " 5", 4, 8, 632.0f, 1587.0f),
            MB_STEREO_BAND("_5", " 6", " 6", 5, 8, 1587.0f, 3984.0f),
            MB_STEREO_BAND("_6", " 7", " 7", 6, 8, 3984.0f, 10000.0f),
            MB_STEREO_BAND("_7", " 8", " 8", 7, 8, 10000.0f, 20000.0f),

            MB_BAND_METERS("_0l", " 1 Left"),
            MB_BAND_METERS("_1l", " 2 Left"),
            MB_BAND_METERS("_2l", " 3 Left"),
            MB_BAND_METERS("_3l", " 4 Left"),
            MB_BAND_METERS("_4l", " 5 Left"),
            MB_BAND_METERS("_5l", " 6 Left"),
            MB_BAND_METERS("_6l", " 7 Left"),
            MB_BAND_METERS("_7l", " 8 Left"),

            MB_BAND_METERS("_0r", " 1 Right"),
            MB_BAND_METERS("_1r", " 2 Right"),
            MB_BAND_METERS("_2r", " 3 Right"),
            MB_BAND_METERS("_3r", " 4 Right"),
            MB_BAND_METERS("_4r", " 5 Right"),
            MB_BAND_METERS("_5r", " 6 Right"),
            MB_BAND_METERS("_6r", " 7 Right"),
            MB_BAND_METERS("_7r", " 8 Right"),
        ...
        static const port_t mb_compressor_lr_ports[] =
        {
            ...
            MB_SPLIT("_1l", " 2 Left", " 2 L", 0.0f, 40.0f),
            MB_SPLIT("_2l", " 3 Left", " 3 L", 1.0f, 100.0f),
            MB_SPLIT("_3l", " 4 Left", " 4 L", 0.0f, 252.0f),
            MB_SPLIT("_4l", " 5 Left", " 5 L", 1.0f, 632.0f),
            MB_SPLIT("_5l", " 6 Left", " 6 L", 0.0f, 1587.0f),
            MB_SPLIT("_6l", " 7 Left", " 7 L", 1.0f, 3984.0f),
            MB_SPLIT("_7l", " 8 Left", " 8 L", 0.0f, 10000.0f),

            MB_SPLIT("_1r", " 2 Right", " 2 R", 0.0f, 40.0f),
            MB_SPLIT("_2r", " 3 Right", " 3 R", 1.0f, 100.0f),
            MB_SPLIT("_3r", " 4 Right", " 4 R", 0.0f, 252.0f),
            MB_SPLIT("_4r", " 5 Right", " 5 R", 1.0f, 632.0f),
            MB_SPLIT("_5r", " 6 Right", " 6 R", 0.0f, 1587.0f),
            MB_SPLIT("_6r", " 7 Right", " 7 R", 1.0f, 3984.0f),
            MB_SPLIT("_7r", " 8 Right", " 8 R", 0.0f, 10000.0f),

            MB_SPLIT_BAND("_0l", " 1 Left", " 1 L", 0, 8, 10.0f, 40.0f),
            MB_SPLIT_BAND("_1l", " 2 Left", " 2 L", 1, 8, 40.0f, 100.0f),
            MB_SPLIT_BAND("_2l", " 3 Left", " 3 L", 2, 8, 100.0f, 252.0f),
            MB_SPLIT_BAND("_3l", " 4 Left", " 4 L", 3, 8, 252.0f, 632.0f),
            MB_SPLIT_BAND("_4l", " 5 Left", " 5 L", 4, 8, 632.0f, 1587.0f),
            MB_SPLIT_BAND("_5l", " 6 Left", " 6 L", 5, 8, 1587.0f, 3984.0f),
            MB_SPLIT_BAND("_6l", " 7 Left", " 7 L", 6, 8, 3984.0f, 10000.0f),
            MB_SPLIT_BAND("_7l", " 8 Left", " 8 L", 7, 8, 10000.0f, 20000.0f),

            MB_SPLIT_BAND("_0r", " 1 Right", " 1 R", 0, 8, 10.0f, 40.0f),
            MB_SPLIT_BAND("_1r", " 2 Right", " 2 R", 1, 8, 40.0f, 100.0f),
            MB_SPLIT_BAND("_2r", " 3 Right", " 3 R", 2, 8, 100.0f, 252.0f),
            MB_SPLIT_BAND("_3r", " 4 Right", " 4 R", 3, 8, 252.0f, 632.0f),
            MB_SPLIT_BAND("_4r", " 5 Right", " 5 R", 4, 8, 632.0f, 1587.0f),
            MB_SPLIT_BAND("_5r", " 6 Right", " 6 R", 5, 8, 1587.0f, 3984.0f),
            MB_SPLIT_BAND("_6r", " 7 Right", " 7 R", 6, 8, 3984.0f, 10000.0f),
            MB_SPLIT_BAND("_7r", " 8 Right", " 8 R", 7, 8, 10000.0f, 20000.0f),
        ...
        static const port_t mb_compressor_ms_ports[] =
        {
            ...
            MB_SPLIT("_1m", " 2 Mid", " 2 M", 0.0f, 40.0f),
            MB_SPLIT("_2m", " 3 Mid", " 3 M", 1.0f, 100.0f),
            MB_SPLIT("_3m", " 4 Mid", " 4 M", 0.0f, 252.0f),
            MB_SPLIT("_4m", " 5 Mid", " 5 M", 1.0f, 632.0f),
            MB_SPLIT("_5m", " 6 Mid", " 6 M", 0.0f, 1587.0f),
            MB_SPLIT("_6m", " 7 Mid", " 7 M", 1.0f, 3984.0f),
            MB_SPLIT("_7m", " 8 Mid", " 8 M", 0.0f, 10000.0f),

            MB_SPLIT("_1s", " 2 Side", " 2 S", 0.0f, 40.0f),
            MB_SPLIT("_2s", " 3 Side", " 3 S", 1.0f, 100.0f),
            MB_SPLIT("_3s", " 4 Side", " 4 S", 0.0f, 252.0f),
            MB_SPLIT("_4s", " 5 Side", " 5 S", 1.0f, 632.0f),
            MB_SPLIT("_5s", " 6 Side", " 6 S", 0.0f, 1587.0f),
            MB_SPLIT("_6s", " 7 Side", " 7 S", 1.0f, 3984.0f),
            MB_SPLIT("_7s", " 8 Side", " 8 S", 0.0f, 10000.0f),

            MB_SPLIT_BAND("_0m", " 1 Mid", " 1 M", 0, 8, 10.0f, 40.0f),
            MB_SPLIT_BAND("_1m", " 2 Mid", " 2 M", 1, 8, 40.0f, 100.0f),
            MB_SPLIT_BAND("_2m", " 3 Mid", " 3 M", 2, 8, 100.0f, 252.0f),
            MB_SPLIT_BAND("_3m", " 4 Mid", " 4 M", 3, 8, 252.0f, 632.0f),
            MB_SPLIT_BAND("_4m", " 5 Mid", " 5 M", 4, 8, 632.0f, 1587.0f),
            MB_SPLIT_BAND("_5m", " 6 Mid", " 6 M", 5, 8, 1587.0f, 3984.0f),
            MB_SPLIT_BAND("_6m", " 7 Mid", " 7 M", 6, 8, 3984.0f, 10000.0f),
            MB_SPLIT_BAND("_7m", " 8 Mid", " 8 M", 7, 8, 10000.0f, 20000.0f),

            MB_SPLIT_BAND("_0s", " 1 Side", " 1 S", 0, 8, 10.0f, 40.0f),
            MB_SPLIT_BAND("_1s", " 2 Side", " 2 S", 1, 8, 40.0f, 100.0f),
            MB_SPLIT_BAND("_2s", " 3 Side", " 3 S", 2, 8, 100.0f, 252.0f),
            MB_SPLIT_BAND("_3s", " 4 Side", " 4 S", 3, 8, 252.0f, 632.0f),
            MB_SPLIT_BAND("_4s", " 5 Side", " 5 S", 4, 8, 632.0f, 1587.0f),
            MB_SPLIT_BAND("_5s", " 6 Side", " 6 S", 5, 8, 1587.0f, 3984.0f),
            MB_SPLIT_BAND("_6s", " 7 Side", " 7 S", 6, 8, 3984.0f, 10000.0f),
            MB_SPLIT_BAND("_7s", " 8 Side", " 8 S", 7, 8, 10000.0f, 20000.0f),

            MB_BAND_METERS("_0m", " 1 Mid"),
            MB_BAND_METERS("_1m", " 2 Mid"),
            MB_BAND_METERS("_2m", " 3 Mid"),
            MB_BAND_METERS("_3m", " 4 Mid"),
            MB_BAND_METERS("_4m", " 5 Mid"),
            MB_BAND_METERS("_5m", " 6 Mid"),
            MB_BAND_METERS("_6m", " 7 Mid"),
            MB_BAND_METERS("_7m", " 8 Mid"),

            MB_BAND_METERS("_0s", " 1 Side"),
            MB_BAND_METERS("_1s", " 2 Side"),
            MB_BAND_METERS("_2s", " 3 Side"),
            MB_BAND_METERS("_3s", " 4 Side"),
            MB_BAND_METERS("_4s", " 5 Side"),
            MB_BAND_METERS("_5s", " 6 Side"),
            MB_BAND_METERS("_6s", " 7 Side"),
            MB_BAND_METERS("_7s", " 8 Side"),
        ...
        static const port_t sc_mb_compressor_mono_ports[] =
        {
            ...
            MB_SC_MONO_BAND("_0", " 1", " 1", 0, 8, 10.0f, 40.0f),
            MB_SC_MONO_BAND("_1", " 2", " 2", 1, 8, 40.0f, 100.0f),
            MB_SC_MONO_BAND("_2", " 3", " 3", 2, 8, 100.0f, 252.0f),
            MB_SC_MONO_BAND("_3", " 4", " 4", 3, 8, 252.0f, 632.0f),
            MB_SC_MONO_BAND("_4", " 5", " 5", 4, 8, 632.0f, 1587.0f),
            MB_SC_MONO_BAND("_5", " 6", " 6", 5, 8, 1587.0f, 3984.0f),
            MB_SC_MONO_BAND("_6", " 7", " 7", 6, 8, 3984.0f, 10000.0f),
            MB_SC_MONO_BAND("_7", " 8", " 8", 7, 8, 10000.0f, 20000.0f),
        ...
        static const port_t sc_mb_compressor_stereo_ports[] =
        {
            ...
            MB_SC_STEREO_BAND("_0", " 1", " 1", 0, 8, 10.0f, 40.0f),
            MB_SC_STEREO_BAND("_1", " 2", " 2", 1, 8, 40.0f, 100.0f),
            MB_SC_STEREO_BAND("_2", " 3", " 3", 2, 8, 100.0f, 252.0f),
            MB_SC_STEREO_BAND("_3", " 4", " 4", 3, 8, 252.0f, 632.0f),
            MB_SC_STEREO_BAND("_4", " 5", " 5", 4, 8, 632.0f, 1587.0f),
            MB_SC_STEREO_BAND("_5", " 6", " 6", 5, 8, 1587.0f, 3984.0f),
            MB_SC_STEREO_BAND("_6", " 7", " 7", 6, 8, 3984.0f, 10000.0f),
            MB_SC_STEREO_BAND("_7", " 8", " 8", 7, 8, 10000.0f, 20000.0f),
        ...
        static const port_t sc_mb_compressor_lr_ports[] =
        {
            ...
            MB_SC_SPLIT_BAND("_0l", " 1 Left", " 1 L", 0, 8, 10.0f, 40.0f),
            MB_SC_SPLIT_BAND("_1l", " 2 Left", " 2 L", 1, 8, 40.0f, 100.0f),
            MB_SC_SPLIT_BAND("_2l", " 3 Left", " 3 L", 2, 8, 100.0f, 252.0f),
            MB_SC_SPLIT_BAND("_3l", " 4 Left", " 4 L", 3, 8, 252.0f, 632.0f),
            MB_SC_SPLIT_BAND("_4l", " 5 Left", " 5 L", 4, 8, 632.0f, 1587.0f),
            MB_SC_SPLIT_BAND("_5l", " 6 Left", " 6 L", 5, 8, 1587.0f, 3984.0f),
            MB_SC_SPLIT_BAND("_6l", " 7 Left", " 7 L", 6, 8, 3984.0f, 10000.0f),
            MB_SC_SPLIT_BAND("_7l", " 8 Left", " 8 L", 7, 8, 10000.0f, 20000.0f),

            MB_SC_SPLIT_BAND("_0r", " 1 Right", " 1 R", 0, 8, 10.0f, 40.0f),
            MB_SC_SPLIT_BAND("_1r", " 2 Right", " 2 R", 1, 8, 40.0f, 100.0f),
            MB_SC_SPLIT_BAND("_2r", " 3 Right", " 3 R", 2, 8, 100.0f, 252.0f),
            MB_SC_SPLIT_BAND("_3r", " 4 Right", " 4 R", 3, 8, 252.0f, 632.0f),
            MB_SC_SPLIT_BAND("_4r", " 5 Right", " 5 R", 4, 8, 632.0f, 1587.0f),
            MB_SC_SPLIT_BAND("_5r", " 6 Right", " 6 R", 5, 8, 1587.0f, 3984.0f),
            MB_SC_SPLIT_BAND("_6r", " 7 Right", " 7 R", 6, 8, 3984.0f, 10000.0f),
            MB_SC_SPLIT_BAND("_7r", " 8 Right", " 8 R", 7, 8, 10000.0f, 20000.0f),
        ...
        static const port_t sc_mb_compressor_ms_ports[] =
        {
            ...
            MB_SC_SPLIT_BAND("_0m", " 1 Mid", " 1 M", 0, 8, 10.0f, 40.0f),
            MB_SC_SPLIT_BAND("_1m", " 2 Mid", " 2 M", 1, 8, 40.0f, 100.0f),
            MB_SC_SPLIT_BAND("_2m", " 3 Mid", " 3 M", 2, 8, 100.0f, 252.0f),
            MB_SC_SPLIT_BAND("_3m", " 4 Mid", " 4 M", 3, 8, 252.0f, 632.0f),
            MB_SC_SPLIT_BAND("_4m", " 5 Mid", " 5 M", 4, 8, 632.0f, 1587.0f),
            MB_SC_SPLIT_BAND("_5m", " 6 Mid", " 6 M", 5, 8, 1587.0f, 3984.0f),
            MB_SC_SPLIT_BAND("_6m", " 7 Mid", " 7 M", 6, 8, 3984.0f, 10000.0f),
            MB_SC_SPLIT_BAND("_7m", " 8 Mid", " 8 M", 7, 8, 10000.0f, 20000.0f),

            MB_SC_SPLIT_BAND("_0s", " 1 Side", " 1 S", 0, 8, 10.0f, 40.0f),
            MB_SC_SPLIT_BAND("_1s", " 2 Side", " 2 S", 1, 8, 40.0f, 100.0f),
            MB_SC_SPLIT_BAND("_2s", " 3 Side", " 3 S", 2, 8, 100.0f, 252.0f),
            MB_SC_SPLIT_BAND("_3s", " 4 Side", " 4 S", 3, 8, 252.0f, 632.0f),
            MB_SC_SPLIT_BAND("_4s", " 5 Side", " 5 S", 4, 8, 632.0f, 1587.0f),
            MB_SC_SPLIT_BAND("_5s", " 6 Side", " 6 S", 5, 8, 1587.0f, 3984.0f),
            MB_SC_SPLIT_BAND("_6s", " 7 Side", " 7 S", 6, 8, 3984.0f, 10000.0f),
            MB_SC_SPLIT_BAND("_7s", " 8 Side", " 8 S", 7, 8, 10000.0f, 20000.0f),
